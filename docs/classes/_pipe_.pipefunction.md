...
*Defined in [src/pipe.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/pipe.ts#L3)*
...
*Defined in [src/pipe.ts:9](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/pipe.ts#L9)*
...
*Defined in [src/pipe.ts:5](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/pipe.ts#L5)*
