...
*Defined in [src/compose.ts:13](https://github.com/hermann-p/pragmatic-fp-ts/blob/0abe0d4/src/compose.ts#L13)*
...
*Defined in [src/compose.ts:24](https://github.com/hermann-p/pragmatic-fp-ts/blob/0abe0d4/src/compose.ts#L24)*
