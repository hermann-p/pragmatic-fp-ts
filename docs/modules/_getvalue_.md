[pragmatic-fp-ts](../README.md) › [Globals](../globals.md) › ["getValue"](_getvalue_.md)
...
*Defined in [src/getValue.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/c9716de/src/getValue.ts#L3)*
