...
*Defined in [src/when.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/6562256/src/when.ts#L3)*
...
*Defined in [src/when.ts:8](https://github.com/hermann-p/pragmatic-fp-ts/blob/6562256/src/when.ts#L8)*
...
*Defined in [src/when.ts:12](https://github.com/hermann-p/pragmatic-fp-ts/blob/6562256/src/when.ts#L12)*
