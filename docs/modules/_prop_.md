...
*Defined in [src/prop.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/1e5cfe0/src/prop.ts#L3)*
...
*Defined in [src/prop.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/1e5cfe0/src/prop.ts#L4)*
...
*Defined in [src/prop.ts:5](https://github.com/hermann-p/pragmatic-fp-ts/blob/1e5cfe0/src/prop.ts#L5)*
