...
*Defined in [src/into.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/a1a02fb/src/into.ts#L3)*
...
*Defined in [src/into.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/a1a02fb/src/into.ts#L4)*
...
*Defined in [src/into.ts:8](https://github.com/hermann-p/pragmatic-fp-ts/blob/a1a02fb/src/into.ts#L8)*
...
*Defined in [src/into.ts:12](https://github.com/hermann-p/pragmatic-fp-ts/blob/a1a02fb/src/into.ts#L12)*
...
*Defined in [src/into.ts:13](https://github.com/hermann-p/pragmatic-fp-ts/blob/a1a02fb/src/into.ts#L13)*
