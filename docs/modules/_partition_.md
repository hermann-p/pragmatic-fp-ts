...
*Defined in [src/partition.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/6562256/src/partition.ts#L3)*
...
*Defined in [src/partition.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/6562256/src/partition.ts#L4)*
