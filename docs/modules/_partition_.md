...
*Defined in [src/partition.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/ff16101/src/partition.ts#L3)*
...
*Defined in [src/partition.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/ff16101/src/partition.ts#L4)*
