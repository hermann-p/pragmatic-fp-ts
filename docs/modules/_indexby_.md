...
*Defined in [src/indexBy.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/1e5cfe0/src/indexBy.ts#L3)*
...
*Defined in [src/indexBy.ts:8](https://github.com/hermann-p/pragmatic-fp-ts/blob/1e5cfe0/src/indexBy.ts#L8)*
