...
*Defined in [src/indexBy.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/d50fca4/src/indexBy.ts#L3)*
...
*Defined in [src/indexBy.ts:8](https://github.com/hermann-p/pragmatic-fp-ts/blob/d50fca4/src/indexBy.ts#L8)*
