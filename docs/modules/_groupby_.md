...
*Defined in [groupBy.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/groupBy.ts#L3)*
...
*Defined in [groupBy.ts:7](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/groupBy.ts#L7)*
