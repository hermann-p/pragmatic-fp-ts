...
*Defined in [src/groupBy.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/472cce0/src/groupBy.ts#L3)*
...
*Defined in [src/groupBy.ts:7](https://github.com/hermann-p/pragmatic-fp-ts/blob/472cce0/src/groupBy.ts#L7)*
