...
*Defined in [src/groupBy.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/d50fca4/src/groupBy.ts#L3)*
...
*Defined in [src/groupBy.ts:7](https://github.com/hermann-p/pragmatic-fp-ts/blob/d50fca4/src/groupBy.ts#L7)*
