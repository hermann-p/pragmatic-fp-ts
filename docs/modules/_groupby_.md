...
*Defined in [src/groupBy.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/ae00bcd/src/groupBy.ts#L3)*
...
*Defined in [src/groupBy.ts:7](https://github.com/hermann-p/pragmatic-fp-ts/blob/ae00bcd/src/groupBy.ts#L7)*
