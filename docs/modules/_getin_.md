...
*Defined in [src/getIn.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/1e5cfe0/src/getIn.ts#L4)*
...
*Defined in [src/getIn.ts:5](https://github.com/hermann-p/pragmatic-fp-ts/blob/1e5cfe0/src/getIn.ts#L5)*
...
*Defined in [src/getIn.ts:6](https://github.com/hermann-p/pragmatic-fp-ts/blob/1e5cfe0/src/getIn.ts#L6)*
