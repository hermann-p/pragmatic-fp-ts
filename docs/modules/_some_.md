...
*Defined in [src/some.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/0abe0d4/src/some.ts#L3)*
...
*Defined in [src/some.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/0abe0d4/src/some.ts#L4)*
