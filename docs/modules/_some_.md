...
*Defined in [src/some.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/a1a02fb/src/some.ts#L3)*
...
*Defined in [src/some.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/a1a02fb/src/some.ts#L4)*
