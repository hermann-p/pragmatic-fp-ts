...
*Defined in [src/both.ts:5](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/both.ts#L5)*
...
*Defined in [src/both.ts:6](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/both.ts#L6)*
...
*Defined in [src/both.ts:10](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/both.ts#L10)*
