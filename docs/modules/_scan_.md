...
*Defined in [src/scan.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/893c172/src/scan.ts#L3)*
...
*Defined in [src/scan.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/893c172/src/scan.ts#L4)*
...
*Defined in [src/scan.ts:5](https://github.com/hermann-p/pragmatic-fp-ts/blob/893c172/src/scan.ts#L5)*
