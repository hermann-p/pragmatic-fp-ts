...
*Defined in [src/getValueOr.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/472cce0/src/getValueOr.ts#L3)*
...
*Defined in [src/getValueOr.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/472cce0/src/getValueOr.ts#L4)*
