...
*Defined in [src/find.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/893c172/src/find.ts#L3)*
...
*Defined in [src/find.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/893c172/src/find.ts#L4)*
...
*Defined in [src/find.ts:6](https://github.com/hermann-p/pragmatic-fp-ts/blob/893c172/src/find.ts#L6)*
