...
*Defined in [src/propEq.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/propEq.ts#L4)*
...
*Defined in [src/propEq.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/propEq.ts#L3)*
...
*Defined in [src/propEq.ts:6](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/propEq.ts#L6)*
...
*Defined in [src/propEq.ts:7](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/propEq.ts#L7)*
...
*Defined in [src/propEq.ts:8](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/propEq.ts#L8)*
