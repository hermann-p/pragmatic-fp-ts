...
*Defined in [src/forEach.ts:5](https://github.com/hermann-p/pragmatic-fp-ts/blob/6562256/src/forEach.ts#L5)*
...
*Defined in [src/forEach.ts:6](https://github.com/hermann-p/pragmatic-fp-ts/blob/6562256/src/forEach.ts#L6)*
...
*Defined in [src/forEach.ts:7](https://github.com/hermann-p/pragmatic-fp-ts/blob/6562256/src/forEach.ts#L7)*
...
*Defined in [src/forEach.ts:11](https://github.com/hermann-p/pragmatic-fp-ts/blob/6562256/src/forEach.ts#L11)*
