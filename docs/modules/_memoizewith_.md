...
*Defined in [memoizeWith.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/memoizeWith.ts#L3)*
...
*Defined in [memoizeWith.ts:7](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/memoizeWith.ts#L7)*
