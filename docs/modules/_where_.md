...
*Defined in [src/where.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/d13f3c1/src/where.ts#L3)*
...
*Defined in [src/where.ts:8](https://github.com/hermann-p/pragmatic-fp-ts/blob/d13f3c1/src/where.ts#L8)*
