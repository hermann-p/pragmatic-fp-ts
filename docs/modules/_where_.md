...
*Defined in [src/where.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/0abe0d4/src/where.ts#L3)*
...
*Defined in [src/where.ts:7](https://github.com/hermann-p/pragmatic-fp-ts/blob/0abe0d4/src/where.ts#L7)*
