...
*Defined in [src/where.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/44257be/src/where.ts#L3)*
...
*Defined in [src/where.ts:8](https://github.com/hermann-p/pragmatic-fp-ts/blob/44257be/src/where.ts#L8)*
