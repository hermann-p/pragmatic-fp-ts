...
*Defined in [update.ts:9](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/update.ts#L9)*
...
*Defined in [update.ts:15](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/update.ts#L15)*
...
*Defined in [update.ts:20](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/update.ts#L20)*
...
*Defined in [update.ts:26](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/update.ts#L26)*
...
*Defined in [update.ts:28](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/update.ts#L28)*
...
*Defined in [update.ts:33](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/update.ts#L33)*
...
*Defined in [update.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/65c599f/src/update.ts#L3)*
