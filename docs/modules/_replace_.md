...
*Defined in [src/replace.ts:3](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/replace.ts#L3)*
...
*Defined in [src/replace.ts:4](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/replace.ts#L4)*
...
*Defined in [src/replace.ts:6](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/replace.ts#L6)*
...
*Defined in [src/replace.ts:7](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/replace.ts#L7)*
...
*Defined in [src/replace.ts:8](https://github.com/hermann-p/pragmatic-fp-ts/blob/79e5127/src/replace.ts#L8)*
