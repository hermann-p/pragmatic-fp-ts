...
exports.throwLeftAsError = exports.isEither = exports.isRight = exports.isLeft = exports.either = exports.right = exports.left = exports.Right = exports.Left = void 0;
...
class Right extends types_1.Monad {
    ...
    match(matcher) {
        var _a;
        const m = (_a = matcher.right) !== null && _a !== void 0 ? _a : main_1.identity;
