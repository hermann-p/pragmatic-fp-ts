...
describe("array functions", () => {
    ...
    describe("reduce()", () => {
        it("safely reduces", () => {
            const sum = (result, nextVal) => result + nextVal;
            expect(array_1.reduce(sum)(0)([1, 2, 3]).getValue()).toBe(6);
            expect(array_1.reduce(sum)(undefined)([1, 2, 3])).toBeInstanceOf(Maybe_1.Nothing);
            expect(array_1.reduce(sum)(0)(null)).toBeInstanceOf(Maybe_1.Nothing);
            expect(array_1.reduce(null)(0)([1, 2, 3])).toBeInstanceOf(Maybe_1.Nothing);
        });
    });
    describe("count", () => {
        it("counts array sizes", () => {
            expect(array_1.count([1, 2, 3]).getValue()).toBe(3);
            expect(array_1.count([]).getValue()).toBe(0);
            expect(array_1.count("213").getValue()).toBe(3);
            expect(array_1.count(null)).toBeInstanceOf(Maybe_1.Nothing);
            expect(array_1.count(1)).toBeInstanceOf(Maybe_1.Nothing);
            expect(array_1.count({})).toBeInstanceOf(Maybe_1.Nothing);
        });
    });
});
