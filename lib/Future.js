...
const futureEither = (value) => new Future(main_1.either, main_1.left, main_1.either(value));
exports.futureEither = futureEither;
const futureMaybe = (value) => new Future(main_1.maybe, main_1.nothing, main_1.maybe(value));
exports.futureMaybe = futureMaybe;
const logLeft = (m) => {
    if (main_1.isLeft(m))
